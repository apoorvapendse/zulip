...
export class MessageListView {
    ...
    build_message_groups(messages: Message[]): MessageGroup[] {
        ...
        for (const message of messages) {
            ...
            message_store.mutable_for(message).update_message_reactions(message_reactions);
            message_store.mutable_for(message).update_reminders(
    ...
    _get_message_template(message_container: MessageContainer): string {
        ...
        message_store.mutable_for(message_container.msg).update_message_reactions(
            msg_reactions,
        );
        message_store.mutable_for(message_container.msg).update_reminders(
    ...
    render(
        ...
        for (const message of messages) {
            message_store.mutable_for(message).update_url(
    ...
    update_sticky_recipient_headers(): void {
        ...
        const message_imm = message_store.get(msg_id);
